    ...
    <div class="min-h-screen flex">
        <aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 text-white transform -translate-x-full transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-auto">
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-800">
                <a href="<?= rtrim(env('APP_URL', ''), '/') ?>/admin" class="text-xl font-heading font-bold text-gradient">Admin Panel</a>
            ...
            <nav class="mt-6 px-3 space-y-1">
                <?php
                $navItems = [
                    ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>', 'label' => 'Dashboard', 'path' => '/admin'],
                    ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>', 'label' => 'Categories', 'path' => '/admin/categories'],
                    ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>', 'label' => 'Products', 'path' => '/admin/products'],
                    ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>', 'label' => 'Catalogues', 'path' => '/admin/catalogues'],
                    ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>', 'label' => 'Orders', 'path' => '/admin/orders'],
                    ...
                    ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>', 'label' => 'Content Pages', 'path' => '/admin/content-pages'],
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-800">
                <a href="<?= rtrim(env('APP_URL', ''), '/') ?>/" target="_blank" class="flex items-center space-x-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors mb-2">
        ...
        <div class="flex-1 flex flex-col min-h-screen">
            <header class="bg-white dark:bg-gray-800 shadow-sm px-6 py-4 flex items-center justify-between lg:justify-end">
                ...
                <h1 class="text-lg font-semibold text-gray-800 dark:text-gray-200 lg:hidden"><?= htmlspecialchars($title ?? 'Admin') ?></h1>
                <div class="flex items-center space-x-4">
                    <a href="<?= rtrim(env('APP_URL', ''), '/') ?>/" class="text-sm text-primary-600 hover:text-primary-700 font-medium">View Store</a>
                </div>
            </header>
